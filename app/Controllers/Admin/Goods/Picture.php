    ...
    public function create($GoodsID,$ColorID,$SizeID){
        ...
        for ($i=1;$i<=10;$i++){
            ...
            if ( $file && $file->isFile()) {
                ...
                if(!in_array($file->getMimeType(),["image/jpg","image/png","image/gif","image/jpeg","image/webp"])) return $this->respond(ResponseData::fail("檔案格式限制jpg,png,gif,jpeg,webp"));                //產生隨機名稱
