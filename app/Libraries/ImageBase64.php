...
{
    //Image轉成Base64
    public static function Image_to_Base64($_Path)
    {
    ...
    //Base64轉成Image
    public static function Base64_to_Image($_Base64String, $_Path)
    {
...
//        exit();
    ...
    //Base64圖片類型
    public static function What_Is_Base64Image_Type($_Base64String)
    {
    ...
    //上傳圖片工具
    public static function Base64_UploadFile($_Base64String, $SubDir)
    {
        helper('text');
