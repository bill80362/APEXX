									...
									<div style="width:100% !important;">
										...
										<div
											...
											<div
												...
												<div
													style="font-size: 12px; line-height: 3; text-align: left; color: #0b4e49; font-family: Lato, Tahoma, Verdana, Segoe, sans-serif; mso-line-height-alt: 16px;">
													Hi, <?=$TradeData["ReceiverName"]?><br>

													感謝您對網紅廚房商品的喜愛！<br>

													我們注意到您的購物車尚有商品未訂購完成，特此提醒您在商品完售前完成您的訂單。<br>

													如有任何疑問，再請您立即與<a
														href="https://www.kolshop.com.tw/contact">網紅廚房客服</a>聯繫！
												</div>
											</div>
											<!--[if mso]></td></tr></table><![endif]-->
											<!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 5px; font-family: Tahoma, Verdana, sans-serif"><![endif]-->
										...
										<div
											...
											<div
												...
												<div
													...
													<a href="https://www.kolshop.com.tw/"
														style="font-size: 14px; line-height: 1.2; word-break: break-word; text-align: center; mso-line-height-alt: 17px; margin: 0;background-color: #efbc31;text-decoration: none;font-weight: bold; color: #fff;padding: 15px 25px;border-radius: 5px;">
														馬上到網紅廚房網站逛逛</a>
												</div>
											</div>
											<!--[if mso]></td></tr></table><![endif]-->
