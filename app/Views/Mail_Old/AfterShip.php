										...
										<div
											...
											<div align="center" class="img-container center"
												...
												<!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr style="line-height:0px"><td style="padding-right: 0px;padding-left: 0px;" align="center"><![endif]--><img
													...
													src="https://i.imgur.com/cEaOZEI.gif"
													style="text-decoration: none; -ms-interpolation-mode: bicubic; border: 0; height: auto; width: 100%; max-width: 168px; display: block;"
										...
										<div
											...
											<div
												...
												<div
													...
													<span
														style="font-size: 16px;">你的訂單<?=$TradeData["TradeID"]?>已於<?=$TradeData["ShippingTime"]?>正式出貨</span>
												</div>
											</div>
											<!--[if mso]></td></tr></table><![endif]-->
											<!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 5px; font-family: Tahoma, Verdana, sans-serif"><![endif]-->
									...
									<tbody>
										<tr>
											...
											<td
												...
												<span
													style="font-size:16px;font-weight:600;line-height:1.4;color:#555">總計</span><br>
												...
												<div
                                                    ...
                                                    <p style="line-height: 2; word-break: break-word; mso-line-height-alt: NaNpx; margin: 0;">
                                                        <? if($TradeData["QueryLink"]) { ?>
                                                            <a target="_blank" href="<?=$TradeData["QueryLink"].$TradeData["ShippingCode"]?>">物流編號：<?=$TradeData["ShippingCode"]?></a>
                                                        <? }else{ ?>
                                                            物流編號：<?=$TradeData["ShippingCode"]?>
                                                        <? } ?>
                                                    </p>
                                                    <? } ?>
													<p
